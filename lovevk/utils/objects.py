...
class Warns:
    ...
    def __init__ (self, data: dir):
        self.json = data
        self.left_time_of_ban: int = None
        self.left_time_when_can_communicate: int = None
...
class Users:
    ...
    def __init__(self, data: dir):
        ...
        self.photo_100: str = None
        self.harem_total_price: int = None
        self.verification: bool = None
        self.hp: bool = None
        self.invisible_timestamp: int = None
